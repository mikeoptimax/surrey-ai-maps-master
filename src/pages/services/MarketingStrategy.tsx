...
const MarketingStrategy = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Strategy session form submitted:", formData);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="brutal-card mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ul className="space-y-3">
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Marketing Strategy Consultation</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Business Growth Planning</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Marketing Audit Services</li>
                </ul>
                <ul className="space-y-3">
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Competitor Analysis Reports</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Monthly Marketing Reports</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Marketing Automation Setup</li>
                </ul>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="brutal-card bg-orange text-white sticky top-24">
              ...
              <div className="data-mono text-4xl font-bold mb-4">£997/month</div>
