...
const AIPoweredAutomation = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("AI Automation form submitted:", formData);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="brutal-card mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ul className="space-y-3">
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Lead Automation Systems</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Review Management Automation</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Workflow Optimization</li>
                </ul>
                <ul className="space-y-3">
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Custom n8n Solutions</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> AI Chatbots</li>
                  <li className="flex items-center"><span className="text-orange mr-2">✓</span> Automated Reporting</li>
                </ul>
              </div>
            </div>

            <div className="space-y-8">
              <h3 className="headline-lg text-navy">Automation Success Stories</h3>
              {[
                {
                  business: "Camberley HVAC Company",
                  challenge: "Manual booking chaos, lost leads",
                  result: "100% lead capture + 70% time saved",
                  time: "60 days"
                },
                {
                  business: "Surrey Property Management",
                  challenge: "Missed enquiries, poor follow-up",
                  result: "Instant responses + 300% conversion",
                  time: "45 days"
                },
                {
                  business: "Guildford Construction",
                  challenge: "Manual project management mess",
                  result: "Streamlined ops + 40% profit increase",
                  time: "90 days"
                }
              ].map((study, index) => (
          ...
          <div className="lg:col-span-1">
            <div className="brutal-card bg-orange text-white sticky top-24">
              ...
              <div className="data-mono text-3xl font-bold mb-4">£997-2,500/month</div>
              <p className="mb-6">Based on complexity and integrations needed</p>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Stop losing leads to manual processes. See how AI automation can transform your business.
              </p>
            </div>
